    ...
    <section className="relative overflow-hidden py-20 sm:py-32 text-foreground">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-0">
          <PinContainer title="GitHub" href="https://github.com/vaibhavzalte" target="_blank">
          ...
          <PinContainer title="LeetCode" href="https://leetcode.com/vaibhav_zalte" target="_blank">
          ...
          <PinContainer title="Resume" href="/vaibhav-zalte-resume.pdf" target="_blank">
